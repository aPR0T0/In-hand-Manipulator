...
#include "dynamixel_sdk_inf/srv/detail/get_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_sdk_inf::srv::GetPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_inf::srv::GetPosition_Request & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_inf::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_inf::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  return &dynamixel_sdk_inf::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, srv, GetPosition_Request)() {
  return &dynamixel_sdk_inf::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_inf
cdr_serialize(
  const dynamixel_sdk_inf::srv::GetPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: position
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_inf::srv::GetPosition_Response & ros_message)
{
  // Member: position
  cdr >> ros_message.position;
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_inf::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_inf::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dynamixel_sdk_inf::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, srv, GetPosition_Response)() {
  return &dynamixel_sdk_inf::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
{
  return &dynamixel_sdk_inf::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, srv, GetPosition)() {
  return &dynamixel_sdk_inf::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
