...
#include "dynamixel_sdk_inf/msg/detail/set_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_inf::msg::SetPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_inf::msg::SetPosition *>(
    untyped_ros_message);
...
{
  return &dynamixel_sdk_inf::msg::typesupport_fastrtps_cpp::_SetPosition__handle;
}
