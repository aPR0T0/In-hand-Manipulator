...
#include "dynamixel_sdk_inf/srv/detail/get_position__rosidl_typesupport_fastrtps_c.h"
...
using _GetPosition_Request__ros_msg_type = dynamixel_sdk_inf__srv__GetPosition_Request;
...
size_t get_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetPosition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_sdk_inf
size_t max_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetPosition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_sdk_inf, srv, GetPosition_Request)() {
...
using _GetPosition_Response__ros_msg_type = dynamixel_sdk_inf__srv__GetPosition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_sdk_inf
size_t get_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPosition_Response__ros_msg_type * ros_message = static_cast<const _GetPosition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_sdk_inf
size_t max_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GetPosition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynamixel_sdk_inf__srv__GetPosition_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_sdk_inf, srv, GetPosition_Response)() {
...
// already included above
// #include "dynamixel_sdk_inf/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dynamixel_sdk_inf/srv/get_position.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_sdk_inf, srv, GetPosition)() {
