...
static const _GetPosition_Request_type_support_symbol_names_t _GetPosition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, srv, GetPosition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_inf, srv, GetPosition_Request)),
  }
};
...
{
  return &::dynamixel_sdk_inf::srv::rosidl_typesupport_cpp::GetPosition_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_sdk_inf, srv, GetPosition_Request)() {
  return get_message_type_support_handle<dynamixel_sdk_inf::srv::GetPosition_Request>();
}
...
static const _GetPosition_Response_type_support_symbol_names_t _GetPosition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, srv, GetPosition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_inf, srv, GetPosition_Response)),
  }
};
...
{
  return &::dynamixel_sdk_inf::srv::rosidl_typesupport_cpp::GetPosition_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_sdk_inf, srv, GetPosition_Response)() {
  return get_message_type_support_handle<dynamixel_sdk_inf::srv::GetPosition_Response>();
}
...
static const _GetPosition_type_support_symbol_names_t _GetPosition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, srv, GetPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_inf, srv, GetPosition)),
  }
};
...
{
  return &::dynamixel_sdk_inf::srv::rosidl_typesupport_cpp::GetPosition_service_type_support_handle;
}
