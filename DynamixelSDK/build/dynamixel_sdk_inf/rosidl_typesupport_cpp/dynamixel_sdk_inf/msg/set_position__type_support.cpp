...
static const _SetPosition_type_support_symbol_names_t _SetPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_inf, msg, SetPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamixel_sdk_inf, msg, SetPosition)),
  }
};
...
{
  return &::dynamixel_sdk_inf::msg::rosidl_typesupport_cpp::SetPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamixel_sdk_inf, msg, SetPosition)() {
  return get_message_type_support_handle<dynamixel_sdk_inf::msg::SetPosition>();
}
