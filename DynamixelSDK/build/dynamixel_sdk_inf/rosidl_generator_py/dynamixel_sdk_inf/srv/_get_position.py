...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamixel_sdk_inf.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dynamixel_sdk_inf.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from dynamixel_sdk_inf.srv._get_position import GetPosition_Request as Request
    from dynamixel_sdk_inf.srv._get_position import GetPosition_Response as Response
