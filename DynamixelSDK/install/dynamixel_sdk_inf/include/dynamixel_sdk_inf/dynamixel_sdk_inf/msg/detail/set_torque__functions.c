...
dynamixel_sdk_inf__msg__SetTorque__create()
{
  ...
  dynamixel_sdk_inf__msg__SetTorque * msg = (dynamixel_sdk_inf__msg__SetTorque *)allocator.allocate(sizeof(dynamixel_sdk_inf__msg__SetTorque), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_sdk_inf__msg__SetTorque));
  bool success = dynamixel_sdk_inf__msg__SetTorque__init(msg);
  if (!success) {
...
dynamixel_sdk_inf__msg__SetTorque__destroy(dynamixel_sdk_inf__msg__SetTorque * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dynamixel_sdk_inf__msg__SetTorque__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dynamixel_sdk_inf__msg__SetTorque__Sequence__init(dynamixel_sdk_inf__msg__SetTorque__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_inf__msg__SetTorque * data = NULL;

  if (size) {
    data = (dynamixel_sdk_inf__msg__SetTorque *)allocator.zero_allocate(size, sizeof(dynamixel_sdk_inf__msg__SetTorque), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_sdk_inf__msg__SetTorque__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dynamixel_sdk_inf__msg__SetTorque__fini(&data[i - 1]);
      }
...
dynamixel_sdk_inf__msg__SetTorque__Sequence__fini(dynamixel_sdk_inf__msg__SetTorque__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_sdk_inf__msg__SetTorque__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_inf__msg__SetTorque__Sequence * array = (dynamixel_sdk_inf__msg__SetTorque__Sequence *)allocator.allocate(sizeof(dynamixel_sdk_inf__msg__SetTorque__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_sdk_inf__msg__SetTorque__Sequence__init(array, size);
  if (!success) {
...
dynamixel_sdk_inf__msg__SetTorque__Sequence__destroy(dynamixel_sdk_inf__msg__SetTorque__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_sdk_inf__msg__SetTorque__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dynamixel_sdk_inf__msg__SetTorque__Sequence__are_equal(const dynamixel_sdk_inf__msg__SetTorque__Sequence * lhs, const dynamixel_sdk_inf__msg__SetTorque__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_sdk_inf__msg__SetTorque__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dynamixel_sdk_inf__msg__SetTorque__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_sdk_inf__msg__SetTorque);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_sdk_inf__msg__SetTorque * data =
      (dynamixel_sdk_inf__msg__SetTorque *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_sdk_inf__msg__SetTorque__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_sdk_inf__msg__SetTorque__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_sdk_inf__msg__SetTorque__copy(
